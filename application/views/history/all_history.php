    ...
    <div class="card-header">
        <h3 class="card-title" style="width: 100%;">
            ...
            <div class="input-group input-sm" style="float: right;">
                ...
                <span class="btn btn-primary btn-sm" onclick="showAllHistory();" id="btn_search_history">Search</span>
            </div>
            <a class="btn btn-sm btn-icon-lg btn-light" onclick="showAllHistory('export');" style="float: right;">
...
<div class="modal-content max-w-[600px] top-[10%]">
    <div class="modal-header">
        <h3 class="modal-title">History Filter</h3>
    ...
    <div class="modal-body">
        <div class="grid lg:grid-cols-3 gap-2.5 lg:gap-2.5">
            ...
            <div class="col-span-1 lg:col-span-1">
                <span class="form-hint">Activity Type</span>
                <select class="select" id="activity_type">
    ...
    <div class="modal-body m_foot">
        <div class="flex gap-4" style="float: right;">
            ...
            <button class="btn btn-primary" data-modal-dismiss="true" onclick="showAllHistory();" style="float:right;">Submit</button>
        </div>
    </div>
</div>
</div>
...
function showAllHistory(page = '', in_sort = '') {
    var loading = document.getElementById('loading').innerHTML;
    var val = "?";
    const arr = ["key_history", "dvc_sn", "dvc_name", "admin", "date_from", "date_to", "activity_type", "sort_by", "data_view_history"];
    ...
    if (page == 'export') {
        var link = "<?php echo $config['url_menu']; ?>data/history_export" + val;
