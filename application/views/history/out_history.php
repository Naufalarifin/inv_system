    ...
    <div class="card-header">
        <h3 class="card-title" style="width: 100%;">
            ...
            <div class="input-group input-sm" style="float: right;">
                ...
                <span class="btn btn-primary btn-sm" onclick="showOutHistory();" id="btn_search_history">Search</span>
            </div>
            <a class="btn btn-sm btn-icon-lg btn-light" onclick="showOutHistory('export');" style="float: right;">
...
<div class="modal-content max-w-[600px] top-[10%]">
    <div class="modal-header">
        <h3 class="modal-title">OUT History Filter</h3>
    ...
    <div class="modal-body m_foot">
        <div class="flex gap-4" style="float: right;">
            ...
            <button class="btn btn-primary" data-modal-dismiss="true" onclick="showOutHistory();" style="float:right;">Submit</button>
        </div>
    </div>
</div>
</div>
...
function showOutHistory(page = '', in_sort = '') {
    ...
    if (page == 'export') {
        var link = "<?php echo $config['url_menu']; ?>data/history_export" + val + "&activity_type=OUT";
        window.open(link, '_blank').focus();
    } else {
        val = val + "&p=" + page + "&activity_type=OUT";
