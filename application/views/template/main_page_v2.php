...
<?php for($i=1;$i<=$last;$i++){ if($last!=1){?>
  ...
  <a class="btn btn-<?php if($i==$_GET['p']){ echo "primary"; }else { echo "default"; } ?> hidden-xsx" role="button"
...
<div style="width:100%;text-align: center;padding-top:10px;height:30px;vertical-align: middle;float:left;margin-bottom: 50px;">
