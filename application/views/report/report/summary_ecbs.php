...
$grand_total_over_osc = calculateOscTotal($model_data_over_app);
            ...
            <div class="table-responsive">
                <table class="table table-border align-middle text-gray-700 text-s compact-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td align="center" colspan="15"><i>No ECBS Data Found</i></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                    <tfoot>
            ...
            <div class="table-responsive">
                <table class="table table-border align-middle text-gray-700 text-s compact-table">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td align="center" colspan="5"><i>No ECBS OSC Data Found</i></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                    <tfoot>
