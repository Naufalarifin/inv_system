...
class Report_model extends CI_Model {
    ...
    public function get_week_periods($year, $month) {
        ...
        while ($current_start_ts <= $period_end_ts) {
            // Bergerak harian sampai hari Jumat atau batas periode
            $current_end_ts = $current_start_ts;
            while (date('w', $current_end_ts) != 5 && $current_end_ts < $period_end_ts) {
                $current_end_ts += 86400;
            }
            if ($current_end_ts > $period_end_ts) { $current_end_ts = $period_end_ts; }
            ...
            // Minggu berikutnya mulai sehari setelah current_end_ts
